...
# TODO: obtain confidence intervals
supra_changes <- supra_model_res %>%
...
dt <- dtrt_thresholds %>%
  filter(assay_taste == "sucr")
test <- mixor(rtp ~ days, id = record_id, data = dt)
summary(test)
```
