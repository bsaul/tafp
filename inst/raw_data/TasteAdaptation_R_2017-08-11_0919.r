...
library(Hmisc)
#Read Data
data=read.csv('TasteAdaptation_DATA_2017-08-11_0919.csv')
#Setting Labels
...
label(data$recognition_g1)="Do you recognize the taste?"
...
label(data$recognition_g1b)="Do you recognize the taste?"
...
label(data$sweet_taste_function_assay_complete)="Complete?"
...
label(data$salty_taste_function_assay_complete)="Complete?"
...
label(data$fatty_taste_function_assay_complete)="Complete?"
...
label(data$sweet_suprathreshold_assay_complete)="Complete?"
...
label(data$salty_suprathreshold_assay_complete)="Complete?"
...
label(data$fatty_suprathreshold_assay_complete)="Complete?"
#Setting Units


#Setting Factors(will create new variable for factors)
data$redcap_event_name.factor = factor(data$redcap_event_name,levels=c("day_0_arm_1","day_5_arm_1","final_fasting_day_arm_1","refeed_day_3_arm_1","posttreatment_arm_1"))
...
data$recognition_g1.factor = factor(data$recognition_g1,levels=c("0","1"))
...
data$recognition_g1b.factor = factor(data$recognition_g1b,levels=c("0","1"))
...
data$sweet_taste_function_assay_complete.factor = factor(data$sweet_taste_function_assay_complete,levels=c("0","1","2"))
...
data$salty_taste_function_assay_complete.factor = factor(data$salty_taste_function_assay_complete,levels=c("0","1","2"))
...
data$fatty_taste_function_assay_complete.factor = factor(data$fatty_taste_function_assay_complete,levels=c("0","1","2"))
data$sample_suprataste_1.factor = factor(data$sample_suprataste_1,levels=c("0","1","2","3","4","5"))
data$sweet_suprathreshold_assay_complete.factor = factor(data$sweet_suprathreshold_assay_complete,levels=c("0","1","2"))
data$sample_suprataste_1_v2.factor = factor(data$sample_suprataste_1_v2,levels=c("0","1","2","3","4","5"))
data$salty_suprathreshold_assay_complete.factor = factor(data$salty_suprathreshold_assay_complete,levels=c("0","1","2"))
data$sample_suprataste_1_v3.factor = factor(data$sample_suprataste_1_v3,levels=c("0","1","2","3","4","5"))
data$fatty_suprathreshold_assay_complete.factor = factor(data$fatty_suprathreshold_assay_complete,levels=c("0","1","2"))

levels(data$redcap_event_name.factor)=c("Day 0","Day 5","Final Fasting Day","Refeed Day 3","Post-treatment")
...
levels(data$sweet_taste_function_assay_complete.factor)=c("Incomplete","Unverified","Complete")
...
levels(data$salty_taste_function_assay_complete.factor)=c("Incomplete","Unverified","Complete")
...
levels(data$fatty_taste_function_assay_complete.factor)=c("Incomplete","Unverified","Complete")
levels(data$sample_suprataste_1.factor)=c("Salty","Sweet","Bitter","Sour","Umami","Fatty")
levels(data$sweet_suprathreshold_assay_complete.factor)=c("Incomplete","Unverified","Complete")
levels(data$sample_suprataste_1_v2.factor)=c("Salty","Sweet","Bitter","Sour","Umami","Fatty")
levels(data$salty_suprathreshold_assay_complete.factor)=c("Incomplete","Unverified","Complete")
levels(data$sample_suprataste_1_v3.factor)=c("Salty","Sweet","Bitter","Sour","Umami","Fatty")
levels(data$fatty_suprathreshold_assay_complete.factor)=c("Incomplete","Unverified","Complete")
